...
way 2: Use the optimiumnexus ingress-nginx-controller image.

replace image ingress-nginx-controller with `docker.io/optimiumnexus/ingress-nginx-controller:v1.10.1` in your deployment.
